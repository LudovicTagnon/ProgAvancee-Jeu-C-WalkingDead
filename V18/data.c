...
void writedata(FILE* file, world_t *world){
    ...
    fprintf(file, "%d,%d,%d,%d,%d,%d,%d,%d,%d,", sp.position.x, sp.position.y, sp.speed, sp.dir, sp.life, sp.h, sp.w, sp.disappear, sp.text_dir);
    ...
    fprintf(file, "%d,%d", world->nb_vies_restantes, world->c_s);
