...
void init_data(world_t *world) {
    ...
    for (int i = 0; i < NUMBER_ZOMBIES; i++) {
        ...
        sprite_t tmp_sprite;
        tmp_sprite = init_sprite(tmp_sprite, x, y, 134, 180, 1, Zombie);
    ...
    for (int i = 0; i < NUMBER_TREES; i++) {
        ...
        tmp_sprite = init_sprite(tmp_sprite, x, y, 1000, 1000, 1, Tree);
    ...
    for (int i = 0; i < NUMBER_CHICKEN; i++) {
        ...
        sprite_t tmp_sprite;
        tmp_sprite = init_sprite(tmp_sprite, x, y, 140, 140, 2, Chicken);
