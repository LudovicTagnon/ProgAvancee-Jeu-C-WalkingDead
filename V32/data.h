...
void init_sprite_ptr(sprite_t *sprite, int x, int y, int w, int h, int v, nature_t nature);

sprite_t init_sprite(sprite_t sprite, int x, int y, int w, int h, int v, nature_t nature);
