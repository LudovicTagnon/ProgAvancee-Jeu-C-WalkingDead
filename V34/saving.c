...
void writedata(FILE *file, world_t *world) {
    ...
    fprintf(file, "%d,%d,%d,%d,%d,%d,%d,%d,%d,", world->nb_vies_restantes, world->c_s, world->c_d, world->nb_zombies_killed, world->nb_faim_restant, world->zoom, world->time_debut_jeu, world->time_mort, world->rick_dead);
...
void loadgame(FILE *file, world_t *world) {
    ...
    world->c_s = t[1 + m * 9];
    world->c_d = t[2 + m * 9];
    world->nb_zombies_killed = t[3 + m * 9];
    world->nb_faim_restant = t[4 + m * 9];
    world->zoom = t[5 + m * 9];
    world->time_debut_jeu = t[6 + m * 9];
    world->time_mort = t[7 + m * 9];
    world->rick_dead = t[8 + m * 9];
