        ...
        if (world->quit_menu == 0) {
                    ...
                    if (event->button.button == SDL_BUTTON_LEFT) {
                        if (world->c_s == 1) {
                            ...
                            if (world->Rick.text_dir == 3) {
                                x = world->Rick.position.x - world->Rick.w;
                                y = world->Rick.position.y + 0.07*world->Rick.h;
                                dir = 3;
                            ...
                            tmp_sprite = init_sprite(tmp_sprite, x, y, 16, 16, 50,1, Bullet);
                            tmp_sprite.dir = dir;
                            world->nb_bullets++;
            ...
            if (event->type == SDL_KEYDOWN) {
                ...
                if (event->key.keysym.sym == SDLK_w) {
                    ...
                    if(world->c_d==1 && world->Rick.w > world->Rick.h){
                        int tmp = world->Rick.w;
                        world->Rick.w = world->Rick.h;
                        world->Rick.h = tmp;
                    }
                    ...
                    if(world->c_d==1 && world->Rick.h > world->Rick.w){
                        int tmp = world->Rick.w;
                        world->Rick.w = world->Rick.h;
                        world->Rick.h = tmp;
                    }
